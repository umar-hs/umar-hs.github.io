...
Nah, untuk menjawab pertanyaan-pertanyaan tersebut, dalam artikel ini kita akan mencoba untuk mengulik apa sih IQ nasional?
...
### Rata-rata IQ Indonesia = 78.79?
Unsurprisingly, hasil ini lumayan sensasional. Saya sendiri kadang sering melihat angka ini di-post sebagai lelucon (sebagai self-deprecating joke) di Internet oleh orang Indonesia sendiri. Namun, apabila ditinjau secara serius pertanyaan-pertanyaan akan muncul: seberapa akurat estimasi tersebut? Apakah metode yang digunakan oleh Lynn, Becker, dkk valid? Sebelum itu, apakah dataset mereka akurat?
Apabila kita menerima angka tersebut, kita berarti menerima rata-rata IQ penduduk Indonesia di bawah IQ rata-rata dunia (86,72)! 
...
Kritik lain terkait data nasional IQ adalah terkait hasilnya yang outlandish. Seperti yang dikomentarkan oleh Ebbesen (2020), beberapa negara mendapatkan nilai IQ dibawah 70 yang - bagi Ebbesen - hal yang tidak mungkin karena IQ 70 merupakan salah satu kriteria DSM untuk disabilitas intelektual. Negara dengan rata-rata populasi yang memiliki disabilitas intelektual sedikit terlalu tidak memungkinkan. 
